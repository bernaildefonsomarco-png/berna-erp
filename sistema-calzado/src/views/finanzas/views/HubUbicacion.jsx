    ...
    <div className="space-y-5">
      ...
      <div className="hub-card">
        <div className="hub-card-header">
          ...
          <Link
            to={`/finanzas/estado-resultados?ubicacion=${ubicacion.id_ubicacion}`}
      ...
      <div className="hub-card">
        <div className="hub-card-header">
          ...
          <Link
            to={`/finanzas/movimientos?ubicacion=${ubicacion.id_ubicacion}`}
            className="text-xs text-blue-600 hover:underline flex items-center gap-1"
          >
  ...
  if (costos.length === 0) return (
    <div className="space-y-4">
      <EmptyState
        ...
        action={
          <Link to={`/finanzas/costos?ubicacion=${idUbicacion}`} className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-foreground text-background text-sm font-medium hover:opacity-90 transition">
...
function TabEquipo({ trabajadores, idUbicacion }) {
  if (trabajadores.length === 0) return (
    <EmptyState
      ...
      action={
        <Link to="/finanzas/trabajadores" className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-foreground text-background text-sm font-medium hover:opacity-90 transition">
...
export default function HubUbicacion({ usuario }) {
  ...
  if (error || !ubicacion) return (
    <div className="hub-root p-8 text-center">
      ...
      <button onClick={() => navigate('/finanzas/ubicaciones')} className="text-sm text-blue-600 hover:underline">
    ...
    <div className="hub-root space-y-6 pb-10">
      ...
      <div>
        <div className="flex items-center gap-2 text-xs text-muted-foreground mb-3">
          <Link to="/finanzas/ubicaciones" className="hover:text-foreground transition-colors">
            Tiendas y Talleres
          </Link>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Link
          to={`/finanzas/estado-resultados?ubicacion=${id}`}
