  ...
  return (
    <>
      ...
      <p className="text-xs text-muted-foreground mb-3">
        ...
        Para editar cargo, área y nómina, ve a <Link to="/finanzas/trabajadores" className="text-primary underline">Trabajadores</Link>.
      </p>
        ...
        <div className="space-y-4">
          <div className="p-3 rounded-xl border border-border/50 bg-muted/20">
            <p className="text-xs text-muted-foreground mb-1">
              ...
              ve a <Link to="/finanzas/trabajadores" className="text-primary underline font-medium" onClick={onClose}>Trabajadores</Link>.
            </p>
          </div>
